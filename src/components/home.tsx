...
import type { Group, Story } from '../lib/media'
      ...
      <footer className="mt-4 flex items-center justify-between text-neutral-500">
        <div className="flex items-center gap-5">
          <button
            type="button"
            onClick={onLike}
            className={`flex items-center gap-1.5 text-[14px] transition-colors hover:text-accent-600 ${
              post.liked ? 'text-accent-600' : ''
            }`}
            aria-pressed={!!post.liked}
          >
            <HeartIcon width={21} height={21} /> {post.likes}
          </button>
          <button type="button" className="flex items-center gap-1.5 text-[14px] transition-colors hover:text-ink">
            <CommentIcon width={21} height={21} /> {post.comments}
          </button>
          <button type="button" className="hidden items-center transition-colors hover:text-ink sm:flex">
            <SmileIcon width={21} height={21} />
          </button>
          <button type="button" className="flex items-center transition-colors hover:text-ink">
        ...
        <button
          type="button"
          onClick={onBookmark}
          className={`transition-colors hover:text-ink ${post.bookmarked ? 'text-ink' : ''}`}
