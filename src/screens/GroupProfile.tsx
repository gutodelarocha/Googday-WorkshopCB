...
const groupData: Record<string, {
  ...
  pedal: {
    ...
    posts: [{ id: 'p1', avatar: '/assets/4b35d.png', name: 'Tiago Souza', handle: '@tiago_souza', time: '8 h', text: 'Resumo do pedal de ontem: 32 km, 8 participantes e muita risada マウンテン‍♀️', image: '/assets/48d71.png', likes: 68, comments: 24 }],
  },
  hiking: {
  ...
  natacao: {
    ...
    cover: 'https://images.unsplash.com/photo-1530549387789-4c1017266635?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=900',
    privacy: 'Público',
    subgroups: 8,
    members: 287,
    postsCount: 134,
    description: 'Treinos de natação, águas abertas e dicas de técnica. Do iniciante ao atleta.',
    category: 'Esportes',
    memberAvatars: [
      'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=160&h=160',
      'https://images.unsplash.com/photo-1544005313-94ddf0286df2?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=160&h=160',
      'https://images.unsplash.com/photo-1568602471122-7832951cc4c5?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=160&h=160',
    ],
    posts: [
      { id: 'p1', avatar: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=160&h=160', name: 'Gabriel Nunes', handle: '@gab_nunes', time: '3 h', text: '2k contínuos na piscina hoje. Braçada limpa, respiração a cada 3. Quem topa o challenge?', image: 'https://images.unsplash.com/photo-1530549387789-4c1017266635?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=900', likes: 45, comments: 11 },
      { id: 'p2', avatar: 'https://images.unsplash.com/photo-1568602471122-7832951cc4c5?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=160&h=160', name: 'Diego Alves', handle: '@diego_run', time: '1 d', text: 'Águas abertas no Guarujá domingo 7h. Água ~22°C. Leve boia e óculos escuro!', likes: 62, comments: 28 },
    ],
  },
  meditacao: {
    id: 'meditacao',
    name: 'Meditação Guiada',
    cover: 'https://images.unsplash.com/photo-1506126613408-eca07ce68773?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=900',
    privacy: 'Público',
    subgroups: 5,
    members: 412,
    postsCount: 201,
    description: 'Sessões diárias, respiração e mindfulness em comunidade. Sem julgamento, só presença.',
    category: 'Bem-estar',
    memberAvatars: [
      'https://images.unsplash.com/photo-1544005313-94ddf0286df2?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=160&h=160',
      'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=160&h=160',
      '/assets/988ee.png',
    ],
    posts: [
      { id: 'p1', avatar: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=160&h=160', name: 'Helena Souza', handle: '@helena_souza', time: '2 h', text: 'Meditação das 7h: 12 minutos de body scan. Quem participou, como se sentiu?', image: 'https://images.unsplash.com/photo-1506126613408-eca07ce68773?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=900', likes: 88, comments: 19 },
    ],
  },
  escalada: {
    id: 'escalada',
    name: 'Escalada Indoor',
    cover: 'https://images.unsplash.com/photo-1522163186145-024defcf126d?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=900',
    privacy: 'Público',
    subgroups: 6,
    members: 198,
    postsCount: 89,
    description: 'Boulder, vias e projetos. Todos os níveis no ginásio.',
    category: 'Esportes',
    memberAvatars: [
      'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=160&h=160',
      'https://images.unsplash.com/photo-1568602471122-7832951cc4c5?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=160&h=160',
      '/assets/2f96e.png',
    ],
    posts: [
      { id: 'p1', avatar: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=160&h=160', name: 'Otávio Reis', handle: '@otavio_reis', time: '5 h', text: 'Fechei o V4 do setor azul! Sessão de 2h e muita pele gasta 🧗', image: 'https://images.unsplash.com/photo-1522163186145-024defcf126d?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=900', likes: 54, comments: 15 },
    ],
  },
  pilates_mat: {
    id: 'pilates_mat',
    name: 'Pilates Mat',
    cover: 'https://images.unsplash.com/photo-1518611012118-696072aa579a?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=900',
    privacy: 'Privado',
    subgroups: 4,
    members: 356,
    postsCount: 162,
    description: 'Aulas de pilates no solo, core e mobilidade para o dia a dia.',
    category: 'Fitness',
    memberAvatars: [
      'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=160&h=160',
      '/assets/a35b8.png',
    ...
    posts: [
      { id: 'p1', avatar: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=160&h=160', name: 'Fernanda Oliveira', handle: '@fe_oliveira', time: '4 h', text: 'Sequência de hoje: 100, roll-up e side kick. Core pegando fogo 🔥', image: 'https://images.unsplash.com/photo-1518611012118-696072aa579a?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=900', likes: 71, comments: 22 },
    ],
  },
  vegan: {
    id: 'vegan',
    ...
    members: 521,
    postsCount: 278,
    description: 'Receitas plant-based práticas para o dia a dia, sem complicação.',
    category: 'Saúde',
    memberAvatars: [
      'https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=160&h=160',
      '/assets/eec11.png',
      '/assets/7c77a.png',
    ],
    posts: [
      { id: 'p1', avatar: 'https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=160&h=160', name: 'Patricia Lima', handle: '@pati_lima', time: '6 h', text: 'Bowl de grão-de-bico, quinoa e tahine. 15 minutos e zero culpa 🥗', image: '/assets/074f9.png', likes: 96, comments: 31 },
    ],
  },
  calcada: {
    id: 'calcada',
    name: 'Caminhada Matinal',
    cover: 'https://images.unsplash.com/photo-1476480862126-209faa2f0b4e?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=900',
    privacy: 'Público',
    subgroups: 7,
    members: 634,
    postsCount: 195,
    description: 'Encontros cedo para caminhar, conversar e começar bem o dia.',
    category: 'Esportes',
    memberAvatars: [
      'https://images.unsplash.com/photo-1568602471122-7832951cc4c5?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=160&h=160',
      '/assets/0b179.png',
    ...
    posts: [
      { id: 'p1', avatar: 'https://images.unsplash.com/photo-1568602471122-7832951cc4c5?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=160&h=160', name: 'Diego Alves', handle: '@diego_run', time: '8 h', text: 'Caminhada de 5km no Ibirapuera amanhã 6h30. Ritmo leve, papo bom. Quem vem?', image: 'https://images.unsplash.com/photo-1476480862126-209faa2f0b4e?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=900', likes: 41, comments: 17 },
    ],
  },
}
