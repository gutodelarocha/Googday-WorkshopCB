...
const searchPeople = [
  ...
  { id: 'diego', name: 'Diego Alves', handle: '@diego_run', avatar: 'https://images.unsplash.com/photo-1568602471122-7832951cc4c5?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=160&h=160', interests: 4 },
  { id: 'fernanda', name: 'Fernanda Oliveira', handle: '@fe_oliveira', avatar: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=160&h=160', interests: 5 },
  { id: 'gabriel', name: 'Gabriel Nunes', handle: '@gab_nunes', avatar: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=160&h=160', interests: 3 },
  { id: 'helena', name: 'Helena Souza', handle: '@helena_souza', avatar: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=160&h=160', interests: 4 },
  { id: 'otavio', name: 'Otávio Reis', handle: '@otavio_reis', avatar: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=160&h=160', interests: 2 },
  { id: 'patricia', name: 'Patricia Lima', handle: '@pati_lima', avatar: 'https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=160&h=160', interests: 6 },
]
...
const searchGroups = [
  ...
  { id: 'natacao', name: 'Natação & Águas Abertas', cover: 'https://images.unsplash.com/photo-1530549387789-4c1017266635?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=900', members: 287, privacy: 'Público' },
  { id: 'meditacao', name: 'Meditação Guiada', cover: 'https://images.unsplash.com/photo-1506126613408-eca07ce68773?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=900', members: 412, privacy: 'Público' },
  { id: 'escalada', name: 'Escalada Indoor', cover: 'https://images.unsplash.com/photo-1522163186145-024defcf126d?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=900', members: 198, privacy: 'Público' },
  { id: 'pilates_mat', name: 'Pilates Mat', cover: 'https://images.unsplash.com/photo-1518611012118-696072aa579a?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=900', members: 356, privacy: 'Privado' },
  { id: 'vegan', name: 'Cozinha Vegana', cover: '/assets/074f9.png', members: 521, privacy: 'Público' },
  { id: 'calcada', name: 'Caminhada Matinal', cover: 'https://images.unsplash.com/photo-1476480862126-209faa2f0b4e?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=900', members: 634, privacy: 'Público' },
]

const recentChips = ['corrida', 'natação', 'pilates', 'meditação', 'escalada']
