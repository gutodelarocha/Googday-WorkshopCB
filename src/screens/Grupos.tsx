...
const gruposData: GrupoItem[] = [
  ...
  },
  {
    ...
    description: 'Treinos de natação, águas abertas e dicas de técnica.',
  ...
  },
  {
    ...
    description: 'Sessões diárias, respiração e mindfulness em comunidade.',
  ...
  },
  {
    id: 'pilates_mat',
    name: 'Pilates Mat',
    description: 'Aulas de pilates no solo, core e mobilidade.',
  ...
  },
  {
    id: 'vegan',
    name: 'Cozinha Vegana',
    description: 'Receitas plant-based práticas para o dia a dia.',
    cover: '/assets/074f9.png',
    members: 521,
    posts: 278,
    status: 'Público',
...
const filters = ['Todos', 'Participando', 'Sugeridos', 'Corrida', 'Natação', 'Pilates', 'Meditação', 'Escalada']
