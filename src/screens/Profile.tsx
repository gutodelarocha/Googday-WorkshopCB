...
const profileData: Record<string, {
  ...
  diego: {
    ...
    name: 'Diego Alves',
    handle: '@diego_run',
    avatar: 'https://images.unsplash.com/photo-1568602471122-7832951cc4c5?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=160&h=160',
    cover: 'https://images.unsplash.com/photo-1476480862126-209faa2f0b4e?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=900',
    location: 'São Paulo, SP',
    bio: 'Pace obsessivo e café preto. Treinos intervalados e longões de domingo. ⏱️',
    interests: ['Corrida', 'Triathlon', 'Ciclismo'],
    followers: 2180,
    following: 340,
    posts: ['/assets/40f99.png', '/assets/48d71.png', '/assets/074f9.png', '/assets/89f86.png'],
  },
  fernanda: {
    id: 'fernanda',
    name: 'Fernanda Oliveira',
    handle: '@fe_oliveira',
    avatar: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=160&h=160',
    cover: 'https://images.unsplash.com/photo-1518611012118-696072aa579a?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=900',
    location: 'Campinas, SP',
    bio: 'Instrutora de pilates. Postura, respiração e força do core. 🧘‍♀️',
    interests: ['Pilates', 'Yoga', 'Meditação', 'Nutrição'],
    followers: 3650,
    following: 198,
    posts: ['/assets/8aa91.png', '/assets/40f99.png', '/assets/f71df.png', '/assets/074f9.png', '/assets/89f86.png'],
  },
  gabriel: {
    id: 'gabriel',
    name: 'Gabriel Nunes',
    handle: '@gab_nunes',
    avatar: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=160&h=160',
    cover: 'https://images.unsplash.com/photo-1530549387789-4c1017266635?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=900',
    location: 'Santos, SP',
    bio: 'Nadador amador. Águas abertas no fim de semana e piscina no meio da semana. 🏊',
    interests: ['Natação', 'Triathlon', 'Corrida'],
    followers: 1420,
    following: 267,
    posts: ['/assets/48d71.png', '/assets/40f99.png', '/assets/074f9.png'],
  },
  helena: {
    id: 'helena',
    name: 'Helena Souza',
    handle: '@helena_souza',
    avatar: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=160&h=160',
    cover: 'https://images.unsplash.com/photo-1506126613408-eca07ce68773?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=900',
    location: 'Brasília, DF',
    bio: 'Mindfulness e respiração consciente. Menos pressa, mais presença. ✨',
    interests: ['Meditação', 'Yoga', 'Pilates', 'Vida natural'],
    followers: 5890,
    following: 412,
    posts: ['/assets/8aa91.png', '/assets/f71df.png', '/assets/40f99.png', '/assets/074f9.png', '/assets/89f86.png', '/assets/48d71.png'],
  },
  otavio: {
    id: 'otavio',
    name: 'Otávio Reis',
    handle: '@otavio_reis',
    avatar: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=160&h=160',
    cover: 'https://images.unsplash.com/photo-1522163186145-024defcf126d?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=900',
    location: 'Belo Horizonte, MG',
    bio: 'Escalada indoor e boulder. Projetando o próximo V5. 🧗',
    interests: ['Escalada', 'Hiking', 'Treino Funcional'],
    followers: 980,
    following: 155,
    posts: ['/assets/89f86.png', '/assets/074f9.png', '/assets/40f99.png', '/assets/48d71.png'],
  },
  patricia: {
    id: 'patricia',
    name: 'Patricia Lima',
    handle: '@pati_lima',
    avatar: 'https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&q=80&w=160&h=160',
    cover: '/assets/074f9.png',
    location: 'São Paulo, SP',
    bio: 'Cozinha plant-based sem drama. Bowls, fermentados e muito verde. 🥗',
    interests: ['Nutrição', 'Alimentação Saudável', 'Sucos', 'Vida natural', 'Culinária saudável'],
    followers: 7240,
    following: 501,
    posts: ['/assets/074f9.png', '/assets/f71df.png', '/assets/8aa91.png', '/assets/40f99.png', '/assets/48d71.png', '/assets/89f86.png'],
  },
}
